...
export default function TestingPage() {
  ...
  return (
    <div className="relative mt-18.75 min-h-[calc(100vh-75px)] flex flex-col items-center justify-center bg-white text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-4">
              ...
              {step === 2 && (
                <button
                  type="submit"
                  className="px-6 py-2 rounded bg-black text-white"
                  disabled={!form.location.trim() || processing}
                >
                  Submit
                </button>
              )}
      ...
      {submitted && (
        <Link
          href={"/results"}
          className="absolute group flex gap-4 items-center bottom-8 right-10 z-20 cursor-pointer animate-proceed"
